-- Create the missing daily_province_range_stats table
...
-- Fix get_user_buff() to handle missing tables gracefully
  ...
  IF v_user.team = 'red' THEN
    ...
    ELSE
      ...
      IF v_red_runner_count > 0 THEN
        -- Elite threshold = top 20% flip_points among RED in district yesterday
