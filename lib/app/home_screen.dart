...
import '../features/run/providers/run_provider.dart';
...
import '../features/run/screens/running_screen.dart';
import '../features/team/screens/team_screen.dart';
import '../features/history/screens/run_history_screen.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void _showProvinceNotification() {
    final teamColor =
        ref.read(userRepositoryProvider)?.team.color ??
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                // Buff badge (authenticated only) + Flip Points (always shown)
                if (!isGuest) ...[
...
class _BuffBadge extends ConsumerWidget {
