...
class UserModel {
  ...
  factory UserModel.mergeWithServerStats(
    ...
    return UserModel(
      ...
      homeHex: (stats['home_hex'] as String?) ?? existing.homeHex,
      homeHexEnd: (stats['home_hex_end'] as String?) ?? existing.homeHexEnd,
      seasonHomeHex: (stats['season_home_hex'] as String?) ?? existing.seasonHomeHex,
