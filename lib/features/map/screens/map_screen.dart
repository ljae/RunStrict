              ...
              Positioned(
                ...
                child: isLandscape
                    ? Column(
                        ...
                        children: [
                          if (!ref.watch(proProvider)) const _NativeAdCard(),
...
class _HexMapCard extends ConsumerWidget {
...
class _OutsideProvinceBanner extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final teamColor =
        ref.watch(userRepositoryProvider)?.team.color ?? AppTheme.electricBlue;
