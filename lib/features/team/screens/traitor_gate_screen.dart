...
class TraitorGateScreen extends ConsumerStatefulWidget {
  const TraitorGateScreen({super.key});

  @override
  ConsumerState<TraitorGateScreen> createState() => _TraitorGateScreenState();
}

class _TraitorGateScreenState extends ConsumerState<TraitorGateScreen> {
  ...
  Future<void> _performDefection() async {
    ...
    try {
      await ref.read(appStateProvider.notifier).defectToPurple();
  ...
  Widget build(BuildContext context) {
    ...
    final isRunning = ref.watch(runProvider).isRunning;
