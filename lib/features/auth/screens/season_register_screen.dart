...
class SeasonRegisterScreen extends ConsumerStatefulWidget {
  const SeasonRegisterScreen({super.key});

  @override
  ConsumerState<SeasonRegisterScreen> createState() => _SeasonRegisterScreenState();
}

class _SeasonRegisterScreenState extends ConsumerState<SeasonRegisterScreen>
  ...
  Future<void> _handleTeamSelection(BuildContext context, Team team) async {
    ...
    try {
      ...
      // go_router redirect handles navigation after team selection.
    } catch (e) {
      if (mounted) {
